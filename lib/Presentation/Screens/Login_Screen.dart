              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        isLogin ? Constants.login_text : Constants.signUp_text,
                        style: TextStyle(
                          fontSize: 20.h,
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      isLogin ? Constants.signUp_text : Constants.login_text,
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Divider(color: Colors.black, height: 26),
                    ),
                  ),
                  Text("OR"),
                  Expanded(
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      ...
                      final id = await UserModel().insertUser(
                        UserList(
